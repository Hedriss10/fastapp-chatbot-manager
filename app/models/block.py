...
class ScheduleBlock(Base):
    ...
    employee_id: Mapped[int] = mapped_column(Integer, ForeignKey('employee.employees.id'), nullable=False)
    ...
    is_block: Mapped[bool] = mapped_column(Boolean, server_default=text('false'), nullable=False)
