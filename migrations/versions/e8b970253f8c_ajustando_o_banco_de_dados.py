...
Revision ID: e8b970253f8c
Revises: 
Create Date: 2025-09-17 21:19:01.832455
...
def upgrade() -> None:
    ...
    sa.Column('next_message_id', sa.UUID(), nullable=False),
    ...
    sa.Column('deleted_at', sa.DateTime(), nullable=True),
    sa.Column('is_deleted', sa.Boolean(), nullable=False),
    sa.ForeignKeyConstraint(['employee_id'], ['employee.employees.id'], name=op.f('fk_schedule_employee_id_employees')),
    sa.ForeignKeyConstraint(['product_id'], ['finance.products.id'], name=op.f('fk_schedule_product_id_products')),
